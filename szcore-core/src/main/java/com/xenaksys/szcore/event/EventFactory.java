...
public class EventFactory {
    ...
    public OverlayTextEvent createOverlayTextEvent(StaveId staveId, String txt, boolean isVisible, OverlayType overlayType, String destination, long creationTime) {
        return new OverlayTextEvent(staveId, txt, isVisible, overlayType, destination, creationTime);
    }
