...
public class WebPositionStartLfoConfig extends WebOscillatorConfig {
    ...
    public WebPositionStartLfoConfig(PropertyChangeSupport pcs) {
        super(pcs, WEB_OBJ_CONFIG_GRANULATOR, WEB_CONFIG_POSITION_OSCILLATOR,
                WEB_CONFIG_POSITION_OSCILLATOR + DOT + WEB_CONFIG_START_LFO + DOT);
    ...
    public WebPositionStartLfoConfig copy(WebPositionStartLfoConfig to) {
        return (WebPositionStartLfoConfig) super.copy(to);
    }
}
