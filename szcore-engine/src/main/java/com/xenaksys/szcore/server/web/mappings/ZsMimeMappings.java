package com.xenaksys.szcore.server.web.mappings;

import java.util.Collections;
import java.util.HashMap;
import java.util.Map;

public class ZsMimeMappings {

    public static final Map<String, String> ZSCORE_MIME_MAPPINGS;
    ...
    static {
        ...
        defaultMappings.put("wasm", "application/wasm");

        ZSCORE_MIME_MAPPINGS = Collections.unmodifiableMap(defaultMappings);
    }
}
