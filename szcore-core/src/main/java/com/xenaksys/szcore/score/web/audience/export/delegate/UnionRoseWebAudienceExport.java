...
public class UnionRoseWebAudienceExport implements WebAudienceScoreStateExport {
    ...
    public UnionRoseWebAudienceExport(TileExport[][] tiles, List<WebAudienceAction> currentActions,
