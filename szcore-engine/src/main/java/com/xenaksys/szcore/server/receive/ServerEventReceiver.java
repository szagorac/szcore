...
//    private final OscReceiver processor;
    private final InEventContainerDisruptorProcessor processor;
    private final OscReceiveProcessor eventReceiver;

    public ServerEventReceiver(InEventContainerDisruptorProcessor processor, OscReceiveProcessor eventReceiver, OscListenerId id) {
        super(id);
