...
public class WebPositionEndLfoConfig extends WebOscillatorConfig {
    ...
    public WebPositionEndLfoConfig(PropertyChangeSupport pcs) {
        super(pcs, WEB_OBJ_CONFIG_GRANULATOR, WEB_CONFIG_POSITION_OSCILLATOR,
                WEB_CONFIG_POSITION_OSCILLATOR + DOT + WEB_CONFIG_END_LFO + DOT);
    ...
    public WebPositionEndLfoConfig copy(WebPositionEndLfoConfig to) {
        return (WebPositionEndLfoConfig) super.copy(to);
    }
}
